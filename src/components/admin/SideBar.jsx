            ...
            <div
                ...
                onClick={() => {
                    ...
                    if (item.name == "Bảng điều khiển") {
                        navigate('/admin');
                    } else if (item.name == "Tin nhắn & Tư vấn") {
...
export default function SideBar() {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            section: 'CHÍNH',
            subItems: [
                { title: 'Danh sách khóa học', url: './courses' },
                { title: 'Thêm khóa học', url: './add-course' }
            ],
        ...
        },
        {
            ...
            section: 'CHÍNH', subItems: [
                { title: 'Danh sách giáo viên', url: './teachers' },
                { title: 'Thêm giáo viên', url: './add-teacher' }
            ],
            access: ['ADMIN']
        },
        {
            ...
            section: 'CHÍNH',
            subItems: [
                { title: 'Danh sách học viên', url: './students' }
            ],
            access: ['ADMIN', 'COLLABORATOR', 'TEACHER']
        },
        ,
        {
            name: 'Người dùng',
            ...
            section: 'CHÍNH',
            subItems: [
                { title: 'Danh sách người dùng', url: './users' },
                { title: 'Thêm người dùng', url: './add-user' }
            ],
            access: ['ADMIN']
        },
        {
            ...
            section: 'CHÍNH',
            subItems: [
                { title: 'Mã truy cập (Giao dịch)', url: './access-keys' },
                { title: 'Tạo mã', url: './add-key' }
            ],
            access: ['ADMIN', 'COLLABORATOR']
        },
        {
            name: 'Tin tức',
            ...
            section: 'CHÍNH',
            subItems: [
                { title: 'Danh sách tin tức', url: './news' },
                { title: 'Thêm tin tức', url: './add-news' }
            ],
            access: ['ADMIN']
        },
        {
            name: 'Tin nhắn & Tư vấn',
        ...
        },
        {
            ...
            section: 'KHÁC', subItems: [
                { title: 'Cài đặt trang web', url: './settings' },
                { title: 'Bảo mật', url: './users' }
            ],
            access: ['ADMIN']
        },
    ];
                    ...
                    <div key={section} className="mb-4">
                        ...
                        <ul>
                            {menuItems
                                ...
                                .map((item) => (
                                    item.access.includes(Cookies.get('role')) &&
                                    <ItemOption
                                        key={item.name}
                                        item={item}
