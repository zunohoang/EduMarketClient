    ...
    return (
        <div className="h-screen w-1/4">
            <div className="h-full bg-[#2D5D90] text-white">
                ...
                <p className='text-center'>Welcome back <span className='italic font-bold underline'>CTV1</span></p>
                ...
                <NavLink>
                    ...
                    <ul className={`pl-10 text-md flex flex-col transition-all duration-500 ease-in-out overflow-hidden ${coursesDisplay ? 'max-h-40' : 'max-h-0'}`}>
                        ...
                        <Link to={'./courses/code-history'} className='hover:text-[#2D5D90] hover:bg-white'>Lịch sử tạo code</Link>
                    </ul>
                </NavLink>
