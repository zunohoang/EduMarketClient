...
export default function CourseItem({display,id,title,subject,grade,teacher,date,attended,price,isChecked,onChange}) {
        ...
        <tr id={id}>
            ...
            <td className="flex justify-center items-center relative">
                ...
                <div ref={menuRef} className={`${menuDisplay} absolute top-3/4 right-10 z-10 p-2 rounded-lg shadow-2xl bg-white
                    ...
                    <div className="hover:bg-gray-300 text-green-600"  onClick={display}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
